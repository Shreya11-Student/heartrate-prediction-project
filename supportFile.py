...
bpm_calculated = False
bpm_ = 0
def get_frame(new_ewq):
	
	global bpm_
	global bpm_calculated
	bpm_  = new_ewq
	# Helper Methods
	...
	while True:
		...
		if not bpm_ > 0.0:
			...
			cv2.putText(frame, "BPM: %d" %bpm_, bpmTextLocation, font, fontScale, fontColor, lineType)
		print(bpm_)
